...
# srun -n 1 --cpus-per-task 1 perf record -e cpu-cycles,cache-misses,page-faults -g -o ./perf_locality1.data ${CURRENT_DIR}/../build/src/locality ${CURRENT_DIR}/../matrices/matrix5.txt ${CURRENT_DIR}/../matrices/matrix6.txt ${CURRENT_DIR}/../build/result1.txt
# echo ""

# echo "Memory Locality Matrix Multiplication (Optimized with -O2)"
# srun -n 1 --cpus-per-task 1 perf record -e cpu-cycles,cache-misses,page-faults -g -o ./perf_locality2.data ${CURRENT_DIR}/../build/src/locality ${CURRENT_DIR}/../matrices/matrix7.txt ${CURRENT_DIR}/../matrices/matrix8.txt ${CURRENT_DIR}/../build/result2.txt
# echo ""
# echo "Memory Locality Matrix Multiplication (Optimized with -O2)"
...
# echo "CUDA"
# srun -n 1 --gpus ${CURRENT_DIR}/../build/src/gpu/cuda ${CURRENT_DIR}/../matrices/matrix5.txt ${CURRENT_DIR}/../matrices/matrix6.txt ${CURRENT_DIR}/../build/result1.txt
# echo ""
# echo "CUDA"
# srun -n 1 --gpus ${CURRENT_DIR}/../build/src/gpu/cuda ${CURRENT_DIR}/../matrices/matrix7.txt ${CURRENT_DIR}/../matrices/matrix8.txt ${CURRENT_DIR}/../build/result2.txt
# echo ""
...
###OPENACC
# echo "OpenACC"
# srun -n 1 --gpus 1 ${CURRENT_DIR}/../build/src/gpu/openacc ${CURRENT_DIR}/../matrices/matrix5.txt ${CURRENT_DIR}/../matrices/matrix6.txt ${CURRENT_DIR}/../build/result1.txt
# echo ""
# echo "OpenACC"
# srun -n 1 --gpus 1 ${CURRENT_DIR}/../build/src/gpu/openacc ${CURRENT_DIR}/../matrices/matrix7.txt ${CURRENT_DIR}/../matrices/matrix8.txt ${CURRENT_DIR}/../build/result2.txt
# echo ""
